...
class BlogComment
{
     ...
     *
     * @ORM\ManyToOne(targetEntity="BlogBundle\Entity\BlogPost")
     * @ORM\JoinColumns({
     ...
     * Set post
     *
     * @param \BlogBundle\Entity\BlogPost $post
     *
     * @return BlogComment
     */
    public function setPost(\BlogBundle\Entity\BlogPost $post = null)
    {
        $this->post = $post;
